...
class AppColors {
  static final Color textColor = Color.fromARGB(255, 27, 26, 26);
  static final Color mainColor = Color(0xFF89dad8);
  ...
  static final Color card1Color = Color.fromARGB(255, 243, 149, 71);
